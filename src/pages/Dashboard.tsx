    ...
    <div className="mobile-container bg-white relative">
          ...
          <div className="relative">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M17 17a2 2 0 11-4 0 2 2 0 014 0zm-10 0a2 2 0 11-4 0 2 2 0 014 0z"
              />
            </svg>
      ...
      <div className="px-6 mb-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold">
            What's Your <span className="text-purple-500">#Vibe</span> today?
          </h2>
      ...
      <div className="px-6 mb-20">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Your go-to categories, but from unique Indie brands!
        </p>
        ...
        <div className="grid grid-cols-4 gap-3 mb-4">
          {[
            ...
            <div key={index} className="text-center">
              <div
                className={`${item.color} rounded-lg h-20 mb-2 relative overflow-hidden`}
              >
